...
{
	my ($class, %args) = @_;
	$args{endpoint} ||= 'http://127.0.0.1:9332/';
...
Finance::namecoin::API - wrapper for the namecoin JSON-RPC API
...
=head1 SYNOPSIS
 ...
 my $api     = Finance::namecoin::API->new( endpoint => $uri );
